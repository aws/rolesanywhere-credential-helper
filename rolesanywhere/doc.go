...
// requests to RolesAnywhere Service.
//
...
// Using the Client
//
// To contact RolesAnywhere Service with the SDK use the New function to create
...
//
// See the RolesAnywhere Service client RolesAnywhere for more
